...
export EC2_HOME=/opt/ec2/tools                           # Make sure you use the AMI tools you can download using curl -o /tmp/ec2-ami-tools.zip http://s3.amazonaws.com/ec2-downloads/ec2-ami-tools.zip
...
# This variable is for deleting the files from the /mnt/ directory after bundling
shortname=ami-image
#Create the server image filename and manifest filename with todays date ami-image.21.02.2015 and ami-image.21.02.2015.manifest.xml
filename=ami-image
